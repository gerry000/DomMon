...
ActiveRecord::Schema.define(version: 20151015114416) do

  create_table "ldoms", force: :cascade do |t|
    t.string   "hostname",      limit: 255
    t.string   "default_node",  limit: 255
    t.string   "running_node",  limit: 255
    t.integer  "allocated_mem", limit: 4
    t.integer  "used_mem",      limit: 4
    t.integer  "util",          limit: 4
    t.integer  "norm",          limit: 4
